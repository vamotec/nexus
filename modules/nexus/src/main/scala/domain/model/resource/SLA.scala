...
import domain.model.common.{Bandwidth, DailyTimeRange}
...
//                      optimization: CostOptimization
  ...
  case class MaintenanceWindow(
    ...
    allowedTimes: List[DailyTimeRange]
  )
  ...
  case class BusinessHours(
    timezone: String = "UTC",
    weekdays: DailyTimeRange = DailyTimeRange(LocalTime.of(9, 0), LocalTime.of(17, 0)), // 工作日 9-17点
    weekends: Option[DailyTimeRange] = None, // 周末支持
