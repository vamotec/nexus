...
import domain.model.agent.AgentType
import domain.model.common.Goal.{ConstraintAlert, LogicalOperator, RetryPolicy, StateCondition}
...
object Behavior:
  ...
  case class ApplicabilityConditions(
    ...
    timeOfDay: Option[DailyTimeRange] = None // 适用时间段
