...
CREATE TABLE IF NOT EXISTS sessions (
  ...
  -- 标记
  is_marked_as_best BOOLEAN NOT NULL DEFAULT FALSE,
  notes TEXT,
...
CREATE INDEX idx_sessions_is_marked ON sessions(is_marked_as_best) WHERE is_marked_as_best = TRUE;
...
VALUES
  ('admin-001', 'admin@mosia.app', 'Admin User', '$2a$12$dummy_hash', 'admin', TRUE)
